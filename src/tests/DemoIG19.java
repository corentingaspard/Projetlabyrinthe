...
public class DemoIG19 {
	...
	public static void main(String[] args) {
		...
		// Saisie des différents paramatres
		Object parametres[];
		parametres=IG.saisirParametres(); // On ouvre la fenêtre de paramétrage pour la saisie
		
		// Création de la fenêtre de jeu et affichage de la fenétre 
		...
		// Changement des caractèristiques du premier joueur avec les paramètres saisis
